...
public abstract class Expression extends ASTElement {
	 ...
	 * 
	 * rectypeMap is needed in case this expression or a sub-expression 
	 * contains a record field access -- we need to know the types for any
	 * fields that are named 
	 * 
	 ...
	 * 
	 * rectypeMap is needed in case we call a record constructor, or possibly
	 * when we access or modify the field of a record/
	 *  
	 * varAndParamMap is needed in case this expression or a sub-expression
